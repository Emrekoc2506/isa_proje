    ...
    <div className={styles.sectionCard}>
      ...
      {showDetail && selectedOrder && (
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', background: 'rgba(0,0,0,0.75)', backdropFilter: 'blur(4px)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1000, overflowY: 'auto' }}>
          <div className={styles.sectionCard} style={{ width: '90%', maxWidth: 550, margin: '40px auto', background: 'var(--bg-dark)', border: '1px solid var(--border-gold)', boxShadow: '0 8px 32px rgba(0,0,0,0.4)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, textAlign: 'left' }}>
              <div style={{ background: isLight ? 'rgba(0,0,0,0.03)' : 'rgba(255,255,255,0.02)', padding: 12, borderRadius: 6, border: isLight ? '1px solid var(--border-gold)' : '1px solid rgba(255,255,255,0.05)' }}>
                ...
                <p style={{ margin: '0 0 6px 0', fontSize: 13, color: 'var(--text-secondary)' }}>Kargo Metodu: <span style={{ color: 'var(--text-primary)' }}>{selectedOrder.shippingMethodCode || 'Standart'}</span></p>
              ...
              <div>
                ...
                <div style={{ background: isLight ? 'rgba(0,0,0,0.03)' : 'rgba(255,255,255,0.02)', padding: 12, borderRadius: 6, border: isLight ? '1px solid var(--border-gold)' : '1px solid rgba(255,255,255,0.05)' }}>
                  <p style={{ margin: '0 0 4px 0', color: 'var(--text-primary)', fontSize: 13, fontWeight: 600 }}>Teslimat Adresi:</p>
                  {(() => {
