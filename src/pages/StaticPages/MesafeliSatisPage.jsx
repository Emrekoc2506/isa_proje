      ...
      <div className={s.container}>
        ...
        <div className={s.section} style={{ borderColor: 'var(--gold-light)' }}>
          ...
          <p className={s.text}>
            ...
            ALICI, cayma hakkını kullandığı takdirde ürünleri SATICI'nın belirlediği anlaşmalı kargo firması vasıtasıyla mevzuata uygun koşullarla iade etmekle yükümlüdür.
          </p>
        </div>
