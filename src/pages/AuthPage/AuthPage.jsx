  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      try {
        ...
        let errMsg =
          "Favoriler hesabınıza aktarılamadı. Favorileriniz bu cihazda korunuyor.";
      ...
      if (err.requiresVerification === true && err.userId) {
        ...
        setTimeout(() => {
          navigate("/email-dogrulama-bekleniyor", {
            state: { email: loginEmail, userId: err.userId },
          });
        }, 1500);
        return;
      }
            ...
            {isLogin ? (
              ...
              >
                ...
                <p className={styles.formSub}>
                  Mistik yolculuğunuza devam edin
                </p>
              ...
              >
                ...
                <p className={styles.formSub}>
                  Mistik dünyanın kapılarını aralayın
                </p>
